...
class CanceledServicesTable extends StatelessWidget {
  final BookedServicesController bookedServicesController;

  const CanceledServicesTable({
    super.key,
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: DataTable(
        ...
        rows: List.generate(bookedServicesController.canceledServices.length, (
          index,
        ) {
          ServiceResponse service =
              bookedServicesController.canceledServices[index];
          return DataRow(
